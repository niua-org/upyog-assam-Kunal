...
public class UserRequest {
    ...
    public UserRequest(DigiUser user) {
    ...
    private void mapCorrespondenceAddress(DigiUser user) {
    ...
    private void mapPermanentAddress(DigiUser user) {
    ...
    @JsonIgnore
    public DigiUser toDomain(Long loggedInUserId, String loggedInUserUuid, boolean isCreate) {
